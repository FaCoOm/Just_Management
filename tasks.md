...
- [x] 1. Prisma schema migrations (additive)
  - [x] 1.1 Add `stay_experiences` table and back-relations
  ...
  - [x] 1.2 Make `guest_requests.guest_id` and `guest_requests.room_id` nullable
  ...
  - [x] 1.3 Add folio domain tables (`folios`, `folio_line_items`, `folio_payments`)
  ...
  - [x] 1.4 Add `folio_line_item_id` nullable column to `tax_export_items`
...
- [x] 3. Backend services
  - [x] 3.1 Create `operationsEvents` emitter module
  ...
  - [x] 3.2 Implement `StayExperienceService`
  ...
  - [x] 3.3 Modify `GuestRequestService` for reservation-anchored create
  ...
  - [x] 3.4 Implement `CheckInService`
  ...
  - [x] 3.5 Implement `CheckOutService`
  ...
  - [x] 3.7 Implement `DiningEventService`
...
- [x] 4. Backend route registrars
  - [x] 4.1 Register stay-experience routes
  ...
  - [x] 4.2 Register check-in/check-out routes
  ...
  - [x] 4.4 Register dining-event create route
...
- [x] 5. Checkpoint – Backend builds clean
  - Run `cd backend && npm run build`. Ensure no TypeScript errors. Ask the user if questions arise.

- [x] 6. Frontend repository contracts and types
  - [x] 6.1 Add frontend model types to `database.ts`
  ...
  - [x] 6.2 Extend repository contract interfaces in `types.ts`
  ...
  - [x] 6.3 Implement REST adapters in `rest-repositories.ts`
...
- [x] 7. Frontend hooks
  - [x] 7.1 Add query keys for new domains
  ...
  - [x] 7.2 Create `useStayRecordsData` and `useStayExperienceMutations` hooks
  ...
  - [x] 7.3 Create `useCheckInOut` hook
  ...
  - [x] 7.4 Create `useFolioData` and `useFolioMutations` hooks
  ...
  - [x] 7.5 Extend `use-page-data.ts` with dining-event and staff create mutations
...
- [x] 8. Frontend component touchpoints
  - [x] 8.1 Wire stay-records-tab to `useStayRecordsData`
  ...
  - [x] 8.2 Wire check-in-out-page to `useCheckInOut` and folio display
  ...
  - [x] 8.3 Wire guest-requests-tab controls to mutations
  ...
  - [x] 8.4 Add "New Event" dialog to dining-events-page
  ...
  - [x] 8.5 Add "Add Staff" dialog to staff-roles-page
...
- [x] 9. Checkpoint – Frontend builds clean
...
- [x] 10. Property-based tests
  - [x] 10.1 Write property test: stay-experience create requires existing reservation
  ...
  - [x] 10.2 Write property test: stay-experience preserves references and free-form content
  ...
  - [x] 10.3 Write property test: stay-records grouping partitions without loss
  ...
  - [x] 10.4 Write property test: guest-request create is reservation-anchored with optional guest/room
  ...
  - [x] 10.5 Write property test: guest-request status transitions obey transition table
  ...
  - [x] 10.6 Write property test: check-in yields exactly one folio
  ...
  - [x] 10.7 Write property test: check-out finalizes folio and transitions reservation
  ...
  - [x] 10.8 Write property test: check-out rejected outside checked-in lifecycle
  ...
  - [x] 10.9 Write property test: folio balance equals derived ledger formula
  ...
  - [x] 10.10 Write property test: settled folios stay settled at zero balance
  ...
  - [x] 10.11 Write property test: dining-event create validates required fields
  ...
  - [x] 10.12 Write property test: staff create requires role and preserves assignment
  ...
  - [x] 10.13 Write property test: tax-export totals match folio line items with fallback
...
- [x] 11. Operations documentation
  - [x] 11.1 Create operations-pipeline documentation under `docs/`
